						...
						<div class="row row-pb-lg">
							...
							<div class="col-md-4 text-center">
								<div class="product-entry">
									<div class="product-img" style="background-image: url(http://localhost:8000/VIETPRO-STORE-2/public/public/backend/img/{{$item->img}});">
															...
															<div id="menu{{$item->id}}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
																<div class="panel-body">
																	<ul>
																		...
																		<li><a href="danh-sach-san-pham?category={{$cate_child->id}}">{{$cate_child->name}}</a></li>
																		@endif
																		@endforeach
																	</ul>
																</div>
								...
								<div class="side">
									...
									<div class="size-wrap">
										<p class="size-desc">
											...
											<a href="danh-sach-san-pham?value={{$value->id}}" class="attr">{{$value->value}}</a>
											@endforeach
