                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <img id="avatar" class="thumbnail" width="100%" height="350px"
                                                    src="http://localhost:8000/VIETPRO-STORE-2/public/public/backend/img/{{$product->img}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Thông tin</label>
                                        <textarea  class="ckeditor" name="info" style="width: 100%;height: 100px;">{{$product->info}}</textarea>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="editor"  name="description"
                                                    style="width: 100%;height: 100px;" class="ckeditor">{!!$product->describe!!}</textarea>
